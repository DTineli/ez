...
func AdminLoginPage() templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<body class=\"min-h-screen bg-gray-100 flex items-center justify-center p-4\"><div class=\"w-full max-w-sm bg-white shadow-sm border border-gray-200 rounded-xl\"><div class=\"p-6 flex flex-col gap-5\"><div class=\"text-center\"><h1 class=\"text-2xl font-bold\">Acesso Administrativo</h1><p class=\"text-gray-400 text-sm mt-1\">Entre com suas credenciais</p></div><div id=\"login-messages\"></div><form hx-post=\"/admin/login\" hx-target=\"#login-messages\" hx-swap=\"innerHTML\" class=\"flex flex-col gap-4\"><div class=\"flex flex-col gap-1\"><label class=\"flex items-center gap-2 py-1\"><span class=\"text-sm font-medium\">Email</span></label> <input type=\"email\" name=\"email\" class=\"block w-full border border-gray-300 rounded-field bg-white px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50\" placeholder=\"seu@email.com\" required autocomplete=\"email\"></div><div class=\"flex flex-col gap-1\"><label class=\"flex items-center gap-2 py-1\"><span class=\"text-sm font-medium\">Senha</span></label> <input type=\"password\" name=\"password\" class=\"block w-full border border-gray-300 rounded-field bg-white px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50\" placeholder=\"••••••••\" required autocomplete=\"current-password\"></div><button type=\"submit\" class=\"inline-flex items-center justify-center gap-2 cursor-pointer font-medium rounded-field transition-all bg-primary text-primary-content hover:brightness-90 px-3 py-1.5 text-sm mt-1\">Entrar</button></form></div></div></body></html>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
