...
func header(title string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 2, "</title><meta charset=\"UTF-8\"><link rel=\"preconnect\" href=\"https://fonts.googleapis.com\"><link rel=\"preconnect\" href=\"https://fonts.gstatic.com\" crossorigin=\"anonymous\"><link href=\"https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&family=Syne:wght@700;800&family=JetBrains+Mono:wght@400;500&display=swap\" rel=\"stylesheet\"><script src=\"/static/script/htmx.min.js\"></script><script>htmx.config.useTemplateFragments = true;</script><script src=\"/static/script/response-targets.js\"></script><link rel=\"stylesheet\" href=\"/static/css/style.min.css\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><!-- Alpine Plugins --><script defer src=\"https://cdn.jsdelivr.net/npm/@alpinejs/mask@3.x.x/dist/cdn.min.js\"></script><!-- Alpine Core --><script defer src=\"https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js\"></script></head>")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		return nil
	...
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		xData := `{
			...
			getPage() {
				...
				if (p.startsWith('/admin/pricetable')) return 'priceTable';
				if (p.startsWith('/admin/pagamentos')) return 'paymentMethods';
				return 'dashboard';
			},
			pageLabel() {
				const labels = {
		...
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 4, "<body style=\"overflow:hidden;height:100vh;margin:0;padding:0;\"><div id=\"htmx-progress-bar\"></div><div class=\"cs-shell\" x-data=\"")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/layout.templ`, Line: 85, Col: 39}
		}
		_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(templ_7745c5c3_Var4))
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 5, "\"><!-- ═══ SIDEBAR ═══ --><aside class=\"cs-sidebar\" :class=\"{ 'collapsed': collapsed }\"><div class=\"cs-sidebar-logo\"><div class=\"cs-logo-icon\">C</div><div class=\"cs-logo-text\" x-show=\"!collapsed\" x-transition.opacity>Conn<span>Sale</span></div></div><div class=\"cs-sidebar-toggle\" @click=\"collapsed = !collapsed\"><svg width=\"11\" height=\"11\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"2.5\" stroke-linecap=\"round\" stroke-linejoin=\"round\" :style=\"collapsed ? 'transform:rotate(180deg);transition:transform .22s' : 'transition:transform .22s'\"><path d=\"M15 18l-6-6 6-6\"></path></svg></div><nav class=\"cs-sidebar-nav\"><!-- Visão Geral --><a class=\"cs-nav-item\" :class=\"{ 'active': active === 'dashboard' }\" hx-get=\"/admin/\" hx-target=\"#main-content\" hx-push-url=\"true\" hx-swap=\"innerHTML\" hx-indicator=\"#main-content\" @click=\"active = 'dashboard'\"><span class=\"cs-nav-item-icon\"><svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M3 3h7v7H3zM14 3h7v7h-7zM14 14h7v7h-7zM3 14h7v7H3z\"></path></svg></span> <span class=\"cs-nav-item-label\" x-show=\"!collapsed\">Visão Geral</span></a><!-- VENDAS --><div class=\"cs-nav-group-label\">Vendas</div><a class=\"cs-nav-item\" :class=\"{ 'active': active === 'orders' }\" hx-get=\"/admin/pedidos/\" hx-target=\"#main-content\" hx-push-url=\"true\" hx-swap=\"innerHTML\" hx-indicator=\"#main-content\" @click=\"active = 'orders'\"><span class=\"cs-nav-item-icon\"><svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2\"></path> <path d=\"M9 5a2 2 0 002 2h2a2 2 0 002-2\"></path> <path d=\"M9 5a2 2 0 012-2h2a2 2 0 012 2\"></path> <path d=\"M9 14l2 2 4-4\"></path></svg></span> <span class=\"cs-nav-item-label\" x-show=\"!collapsed\">Pedidos</span></a> <a class=\"cs-nav-item\" :class=\"{ 'active': active === 'clients' }\" hx-get=\"/admin/contacts/\" hx-target=\"#main-content\" hx-push-url=\"true\" hx-swap=\"innerHTML\" hx-indicator=\"#main-content\" @click=\"active = 'clients'\"><span class=\"cs-nav-item-icon\"><svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2\"></path> <path d=\"M9 11a4 4 0 100-8 4 4 0 000 8z\"></path></svg></span> <span class=\"cs-nav-item-label\" x-show=\"!collapsed\">Clientes</span></a><!-- CATÁLOGO --><div class=\"cs-nav-group-label\">Catálogo</div><a class=\"cs-nav-item\" :class=\"{ 'active': active === 'products' }\" hx-get=\"/admin/produtos/\" hx-target=\"#main-content\" hx-push-url=\"true\" hx-swap=\"innerHTML\" hx-indicator=\"#main-content\" @click=\"active = 'products'\"><span class=\"cs-nav-item-icon\"><svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4\"></path></svg></span> <span class=\"cs-nav-item-label\" x-show=\"!collapsed\">Produtos</span></a> <a class=\"cs-nav-item\" :class=\"{ 'active': active === 'attributes' }\" hx-get=\"/admin/atributos\" hx-target=\"#main-content\" hx-push-url=\"true\" hx-swap=\"innerHTML\" hx-indicator=\"#main-content\" @click=\"active = 'attributes'\"><span class=\"cs-nav-item-icon\"><svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M7 7h.01M7 12h.01M7 17h.01M11 7h6M11 12h6M11 17h6\"></path></svg></span> <span class=\"cs-nav-item-label\" x-show=\"!collapsed\">Atributos</span></a> <a class=\"cs-nav-item\" :class=\"{ 'active': active === 'priceTable' }\" hx-get=\"/admin/pricetable\" hx-target=\"#main-content\" hx-push-url=\"true\" hx-swap=\"innerHTML\" hx-indicator=\"#main-content\" @click=\"active = 'priceTable'\"><span class=\"cs-nav-item-icon\"><svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><line x1=\"12\" y1=\"1\" x2=\"12\" y2=\"23\"></line> <path d=\"M17 5H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6\"></path></svg></span> <span class=\"cs-nav-item-label\" x-show=\"!collapsed\">Tabela de Preços</span></a> <a class=\"cs-nav-item\" :class=\"{ 'active': active === 'paymentMethods' }\" hx-get=\"/admin/pagamentos\" hx-target=\"#main-content\" hx-push-url=\"true\" hx-swap=\"innerHTML\" hx-indicator=\"#main-content\" @click=\"active = 'paymentMethods'\"><span class=\"cs-nav-item-icon\"><svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><rect x=\"1\" y=\"4\" width=\"22\" height=\"16\" rx=\"2\" ry=\"2\"></rect> <line x1=\"1\" y1=\"10\" x2=\"23\" y2=\"10\"></line></svg></span> <span class=\"cs-nav-item-label\" x-show=\"!collapsed\">Formas de Pagamento</span></a><!-- ANÁLISE --><div class=\"cs-nav-group-label\">Análise</div><a class=\"cs-nav-item\" :class=\"{ 'active': active === 'reports' }\" href=\"#\" @click.prevent=\"active = 'reports'\"><span class=\"cs-nav-item-icon\"><svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M18 20V10M12 20V4M6 20v-6\"></path></svg></span> <span class=\"cs-nav-item-label\" x-show=\"!collapsed\">Relatórios</span></a><!-- SISTEMA --><div class=\"cs-nav-group-label\">Sistema</div><a class=\"cs-nav-item\" :class=\"{ 'active': active === 'config' }\" href=\"#\" @click.prevent=\"active = 'config'\"><span class=\"cs-nav-item-icon\"><svg width=\"16\" height=\"16\" viewBox=\"0 0 24 24\" fill=\"none\" stroke=\"currentColor\" stroke-width=\"1.8\" stroke-linecap=\"round\" stroke-linejoin=\"round\"><path d=\"M12 15a3 3 0 100-6 3 3 0 000 6z\"></path> <path d=\"M19.4 15a1.65 1.65 0 00.33 1.82l.06.06a2 2 0 010 2.83 2 2 0 01-2.83 0l-.06-.06a1.65 1.65 0 00-1.82-.33 1.65 1.65 0 00-1 1.51V21a2 2 0 01-4 0v-.09A1.65 1.65 0 009 19.4a1.65 1.65 0 00-1.82.33l-.06.06a2 2 0 01-2.83-2.83l.06-.06A1.65 1.65 0 004.68 15a1.65 1.65 0 00-1.51-1H3a2 2 0 010-4h.09A1.65 1.65 0 004.6 9a1.65 1.65 0 00-.33-1.82l-.06-.06a2 2 0 012.83-2.83l.06.06A1.65 1.65 0 009 4.68a1.65 1.65 0 001-1.51V3a2 2 0 014 0v.09a1.65 1.65 0 001 1.51 1.65 1.65 0 001.82-.33l.06-.06a2 2 0 012.83 2.83l-.06.06A1.65 1.65 0 0019.4 9a1.65 1.65 0 001.51 1H21a2 2 0 010 4h-.09a1.65 1.65 0 00-1.51 1z\"></path></svg></span> <span class=\"cs-nav-item-label\" x-show=\"!collapsed\">Configurações</span></a></nav><!-- User --><div class=\"cs-sidebar-user\"><div class=\"cs-user-avatar\">")
		if templ_7745c5c3_Err != nil {
			return templ_7745c5c3_Err
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/layout.templ`, Line: 274, Col: 44}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/layout.templ`, Line: 276, Col: 40}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/layout.templ`, Line: 304, Col: 47}
		}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `internal/templates/layout.templ`, Line: 306, Col: 48}
		}
